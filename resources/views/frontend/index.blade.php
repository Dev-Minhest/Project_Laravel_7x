...
@section('title','PiMen Farm | Trang chủ')
                ...
                @foreach($featured as $data)
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="single-banner">
                            ...
                            <div class="content">
                                <p style="color: #ffffff">{{$data->cat_info['title']}}</p>
                                <h3 style="color: rgb(0, 217, 255)">{{$data->title}} <br>Lên đến<span style="color: rgb(0, 255, 21)"> {{$data->discount}}%</span></h3>
                ...
                @foreach($posts as $post)
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="shop-single-blog">
                            ...
                            <div class="content">   
                                <p class="date">{{$post->created_at->format('D, d M Y')}}</p>
