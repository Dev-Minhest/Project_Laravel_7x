...
@endsection
@section('title','PiMen Farm | CHI TIẾT SẢN PHẨM')
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="product-buy">
												...
												<p class="cat mt-1">Hạng mục phụ :<a href="{{route('product-sub-cat',[$product_detail->cat_info['slug'],$product_detail->sub_cat_info['slug']])}}">{{$product_detail->sub_cat_info['title']}}</a></p>
												@endif
                                    ...
                                    <div class="product-img">
                                        ...
                                        <div class="button-head">
                                            <div class="product-action"></div>
                                                <a data-toggle="modal" data-target="#modelExample" title="Quick View" href="#"><i class=" ti-eye"></i><span>Cửa hàng nhanh chóng</span></a>
