                                ...
                                <div class="single-widget">
                                    ...
                                    <div class="content">
                                        <ul>
                                            ...
                                            @if(session('coupon'))
                                            <li class="coupon_price" data-price="{{session('coupon')['value']}}">Bạn tiết kiệm<span>{{number_format(session('coupon')['value'],0)}} vnđ</span></li>
                                            @endif
                                            @php
                                            ...
                                            @endphp
                                            @if(session('coupon'))
                                                <li class="last"  id="order_total_price">Tổng cộng<span>{{number_format($total_amount,0)}} vnđ</span></li>
                                            @else
                                                <li class="last"  id="order_total_price">Tổng cộng<span>{{number_format($total_amount,0)}} vnđ</span></li>
                                            @endif
                                        </ul>
            ...
            <div class="inner-top">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2 col-12">
                        ...
                        <div class="inner">
                            <h4>Bản tin</h4>
                            <p> Đăng ký bản tin của chúng tôi và được giảm giá <span>10%</span> cho lần mua hàng đầu tiên của bạn.</p>
