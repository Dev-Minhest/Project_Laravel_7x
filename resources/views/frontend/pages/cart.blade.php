								...
								@else
										<tr>
											<td class="text-center">
												Không có bất kỳ giỏ hàng nào có sẵn. <a href="{{route('product-grids')}}" style="color:blue;">Tiếp tục mua hàng</a>
											</td>
										</tr>
								@endif
					...
					<div class="total-amount">
						<div class="row">
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										<li class="order_subtotal" data-price="{{Helper::totalCartPrice()}}">Tổng giỏ hàng<span>{{number_format(Helper::totalCartPrice(),0)}} vnđ</span></li>

										@if(session()->has('coupon'))
										<li class="coupon_price" data-price="{{Session::get('coupon')['value']}}">Bạn tiết kiệm<span>{{number_format(Session::get('coupon')['value'],0)}} vnđ</span></li>
										@endif
										@php
										...
										@endphp
										@if(session()->has('coupon'))
											<li class="last" id="order_total_price">Bạn trả<span>{{number_format($total_amount,0)}} vnđ</span></li>
										@else
											<li class="last" id="order_total_price">Bạn trả<span>{{number_format($total_amount,0)}} vnđ</span></li>
										@endif
									</ul>
