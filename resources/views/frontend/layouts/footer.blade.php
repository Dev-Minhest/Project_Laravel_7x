				...
				<div class="row">
					<div class="col-lg-5 col-md-6 col-12">
						...
						<div class="single-footer about">
							<div class="logo">
								<a href="index.html"><img style="width: 30%" src="{{asset('backend/img/logo_pimen.png')}}" alt="#"></a>
							</div>
							@php
				...
				<div class="inner">
					<div class="row">
						<div class="col-lg-6 col-12">
							<div class="left">
								<p>Copyright © {{date('Y')}} <a href="#" target="_blank">PiMen Farm</a>  -  All Rights Reserved.</p>
							</div>
						</div>
						<div class="col-lg-6 col-12">
							<div class="right">
	...
	<script>
	  ...
	  <script>
        ...
        checkbox_toggle.addEventListener('change', function(){
			...
			$('.product-content').toggleClass('dark');
			$('.about-content').toggleClass('dark');
        });
	  </script>