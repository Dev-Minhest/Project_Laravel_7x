...
<header class="header shop">
                ...
                <div class="col-lg-2 col-md-2 col-12">
                    ...
                    <div class="logo">
                        @php
                            $settings=DB::table('settings')->get();
                        @endphp                    
                        <a href="{{route('home')}}"><img style="margin-top: -20px" src="@foreach($settings as $data) {{$data->logo}} @endforeach" alt="logo"></a>
                    </div>
                    <!--/ End Logo -->
                    <!-- Search Form -->
                    ...
                    <div class="right-bar">
                        ...
                        <div class="sinlge-bar shopping">
                            ...
                            @auth
                                <div class="shopping-item">
                                    <div class="dropdown-cart-header">
                                        <span>{{count(Helper::getAllProductFromCart())}} vật phẩm</span>
    ...
    <div id="mode-wrapper">
      ...
      <div class="mode mode__light">
        <p>Light Mode</p>
      </div>
      
      <div class="mode mode__dark">
        <p>Dark Mode</p>
      </div>
