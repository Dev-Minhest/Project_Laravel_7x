...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group">
          <label for="summary" class="col-form-label">Tóm lược <span class="text-danger">*</span></label>
        ...
        <div class="form-group {{(($product->child_cat_id)? '' : 'd-none')}}" id="child_cat_div">
          <label for="child_cat_id">Hạng mục phụ</label>
          <select name="child_cat_id" id="child_cat_id" class="form-control">
              <option value="">--Chọn hạng mục phụ bất kỳ--</option>
        ...
        <div class="form-group">
          ...
          <select name="size[]" class="form-control selectpicker"  multiple data-live-search="true">
              <option value="">--Chọn kích thước bất kỳ--</option>
              ...
              <option value="M"  @if( in_array( "M",$data ) ) selected @endif>Bình thường</option>
              <option value="L"  @if( in_array( "L",$data ) ) selected @endif>Lớn</option>
              <option value="XL"  @if( in_array( "XL",$data ) ) selected @endif>Cực đại</option>
              @endforeach
          </select>
        </div>
        <div class="form-group">
