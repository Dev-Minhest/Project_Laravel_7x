    ...
    <div class="card-body">
      <form method="post" action="{{route('category.update',$category->id)}}">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="title" placeholder="Điền thông tin"  value="{{$category->title}}" class="form-control">
          @error('title')
        ...
        <div class="form-group">
          <label for="summary" class="col-form-label">Tóm lược</label>
        ...
        <div class="form-group">
          <label for="is_parent">Nổi bật</label><br>
